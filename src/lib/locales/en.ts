...
export default {
  ...
  "toolbar.focus": "Focus",
  "toolbar.tidy.tip": "Auto-layout (selection, or everything)",
  "toolbar.tidy": "Tidy",
  ...
  "welcome.hint": "Pick any folder. Notes are stored as markdown files inside it; enable git tracking to sync them between machines.",
  ...
  "prs.none": "No pull requests among the linked references.",
