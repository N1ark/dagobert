...
export default {
  ...
  "action.update.check": "Check for updates…",
  "action.update.install": "Restart to update to {version}",
  ...
  "github.rateLimit": "GitHub rate limit hit — try again in a few minutes.",
  "github.rateLimit.signin": "GitHub rate limit hit — sign in to GitHub in settings for a higher limit.",
  ...
  "update.ready": "Dagobert {version} is ready: restart to install it.",
