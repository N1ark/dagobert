...
const n = (o) => ({ id: "a", title: "", tags: [], created: "", modified: "", opened: "", workflow: null, status: "todo", x: 0, y: 0, deps: [], body: "", file: "", ...o });
...
const e = h.popUndo(); assert.equal(e.label, "type"); assert.equal(h.redo.length, 1);
h.popRedo(); assert.equal(h.redo.length, 0);
h.popUndo(); h.push({ label: "x", diffs: [{ id: "a", before: n({}), after: n({ x: 9 }) }], at: 9000 });
